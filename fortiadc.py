...
class client:
    ...
    def upload_certificate_local(self, **kwargs):
        ...
        r = self._request(method="POST", path="upload/certificate_local", data=data, files=files)
    ...
    def get_certificate_local_group_members(self, **kwargs):
        ...
        r = self._request(path="system_certificate_local_cert_group_child_group_member", params=params)
        return r["payload"]
    ...
    def add_certificate_local_group_member(self, **kwargs):
        ...
        r = self._request(method="POST", path="system_certificate_local_cert_group_child_group_member", json=data, params=params)
    ...
    def delete_certificate_local_group_member(self, **kwargs):
        ...
        r = self._request(method="DELETE", path="system_certificate_local_cert_group_child_group_member", params=params)
        if "payload" not in r or r["payload"] != 0:
            print(r)
